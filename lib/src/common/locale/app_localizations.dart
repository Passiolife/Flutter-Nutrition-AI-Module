...
class AppLocalizations {
  ...
  String get barcodeNotFoundDescription =>
      getLabel('barcodeNotFoundDescription');

  String get customFoodHasBeenCreated => getLabel('customFoodHasBeenCreated');

  String get customFoodCreatedDescription =>
      getLabel('customFoodCreatedDescription');
