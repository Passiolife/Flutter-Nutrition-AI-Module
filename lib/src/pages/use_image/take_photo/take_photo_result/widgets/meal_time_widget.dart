...
class MealTime extends StatefulWidget {
  ...
  final ValueChanged<MealLabel>? onSelected;
...
class _MealTimeState extends State<MealTime> {
  ...
  @override
  void didUpdateWidget(covariant MealTime oldWidget) {
    if (oldWidget.initialMealTime != widget.initialMealTime) {
      if (widget.initialMealTime != null) {
        _selectedMealLabel = KeyValueModel(
            text: widget.initialMealTime!.value,
            value: widget.initialMealTime!);
      }
    }
