...
class NoIngredientsLabelFoundWidget extends StatelessWidget {
  const NoIngredientsLabelFoundWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Text(
            context.localization.noIngredientsLabelFound ?? '',
            style: AppTextStyle.textXl
                .addAll([AppTextStyle.textXl.leading7, AppTextStyle.bold]),
          ),
          Text(
            context.localization.noIngredientsLabelFoundDescription ?? '',
            style: AppTextStyle.textSm.addAll([AppTextStyle.textSm]),
          ),
          16.verticalSpace,
          VectorGraphic(
            loader: AssetBytesLoader(AppImages.icNoIngredientsLabelFound),
            width: 200.r,
            height: 200.r,
          ),
          16.verticalSpace,
