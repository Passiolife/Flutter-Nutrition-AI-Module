...
class _RecipeCreatorScreenState extends State<_RecipeCreatorScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final params = RecipeCreatorNavigationDataModel.of(context);
      _bloc.add(DoConversionEvent(
        logUponCreate: params.logUponCreate,
        loggedFoodRecord: params.loggedFoodRecord,
        recipeFoodRecord: params.recipeFoodRecord,
      ));
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocListener<RecipeCreatorBloc, RecipeCreatorState>(
      ...
      child: Scaffold(
        appBar: PrimaryAppBar(title: context.localization.editRecipe),
        body: SafeArea(
          child: Column(),
        ),
      ),
